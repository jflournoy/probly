...
bayesplot::mcmc_hist(pnorm(true_mu_ep))
bayesplot::mcmc_hist(true_beta_ep, adjust = .5) + ggplot2::coord_cartesian(xlim = c(0,1))
bayesplot::mcmc_hist(true_mu_rho) + ggplot2::coord_cartesian(xlim = c(-5, 5))
bayesplot::mcmc_hist(log(true_beta_rho), adjust = 2) + ggplot2::coord_cartesian(xlim = c(-15, 15))
bayesplot::mcmc_hist(pnorm(true_mu_xi))
bayesplot::mcmc_hist(true_beta_xi, adjust = .05)
bayesplot::mcmc_hist((true_tau_ep), adjust = .05)
bayesplot::mcmc_hist((true_tau_xi), adjust = .05)
bayesplot::mcmc_hist((true_tau_rho), adjust = .05)
bayesplot::mcmc_hist((sample_pR_final), adjust = .05)
```
...
## Lower level parameters ($\beta$)

### Learning rate ($\epsilon$)

```{r showmanyi, fig.width=8, fig.height=30}
i_idx <- sample(1:308, size = 40)
bayesplot::mcmc_hist_by_chain(qnorm(estimated_beta_ep[,i_idx,])) +
    ggplot2::coord_cartesian(xlim = c(-1,2)) +
    ggplot2::geom_vline(
...
```{r}
ggplot2::qplot(true_beta_ep[test_sim_num,,1], 
               apply(estimated_beta_ep, c(2,3), median)[,1], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[1]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_ep[test_sim_num,,2], 
               apply(estimated_beta_ep, c(2,3), median)[,2], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[2]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_ep[test_sim_num,,3], 
               apply(estimated_beta_ep, c(2,3), median)[,3], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[3]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
...
```{r}
ggplot2::qplot(true_beta_rho[test_sim_num,,1], 
               apply(estimated_beta_rho, c(2,3), median)[,1], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[rho[1]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_rho[test_sim_num,,2], 
               apply(estimated_beta_rho, c(2,3), median)[,2], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[rho[2]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_rho[test_sim_num,,3], 
               apply(estimated_beta_rho, c(2,3), median)[,3], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[rho[3]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
```
...
```{r}
ggplot2::qplot(true_beta_xi[test_sim_num,,1], 
               apply(estimated_beta_xi, c(2,3), median)[,1], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[1]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_xi[test_sim_num,,2], 
               apply(estimated_beta_xi, c(2,3), median)[,2], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[2]]))) +
    ggplot2::geom_abline(intercept = 0, slope = 1)
ggplot2::qplot(true_beta_xi[test_sim_num,,3], 
               apply(estimated_beta_xi, c(2,3), median)[,3], 
               geom = c('point', 'smooth'),
               xlab = 'Generative',
               ylab = 'Estimated',
               main = expression(paste(beta[epsilon[3]]))) +
...
```{r pRfinalplot}
ggplot2::ggplot(
    data.frame(Generative = as.numeric(sample_pR_final[test_sim_num,,]), 
               Estimated = as.numeric(apply(estimated_sample_pR_final, c(2,3), median)),
               stimulus = rep(1:6, each = 308)), 
    ggplot2::aes(x = Generative, y = Estimated)) + 
    ggplot2::geom_point(alpha = .5) + 
    ggplot2::facet_wrap(~stimulus) + 
    ggplot2::labs(xlab = 'Generative',
                  ylab = 'Estimated',
                  title = 'Final Probability of Pressing Left (0) or Right (1)') +
    ggplot2::geom_abline(intercept = 0, slope = 1)
```
