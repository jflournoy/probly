...
ksrq_age_pred_plot <- ggplot2::ggplot(
    ...
    ggplot2::geom_point(data = ksrq_age_model_data_l,
                        alpha = .5, position = ggplot2::position_jitter(h=0, w = .2),
...
ksrq_pds_pred_plot <- ggplot2::ggplot(
    ...
    ggplot2::geom_point(data = ksrq_pds_model_data_l,
                        alpha = .5, position = ggplot2::position_jitter(h=0, w = .04),
                        ggplot2::aes(color = factor(gender_c))) +
    ggplot2::geom_line() + 
    ggplot2::facet_wrap(~factor,
                        labeller = ggplot2::labeller(
...
```{r sesfsmiplot, fig.width=8, fig.height=4, eval = F}
