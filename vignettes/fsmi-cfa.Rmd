...
In the college student sample, model fit does not decrease significantly when the association between number of drinking days and FSMI Status is fixed to 0 for any model.
However, comparing the model that includes FSMI Status along with UPPS-P Sensation Seeking, and Negative and Positive Urgency to the same model with the coefficient for Sensation Seeking fixed to 0 shows significant fit decrease.
