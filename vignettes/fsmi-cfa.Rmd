...
ggplot2::qplot(fsmi_num_partners_sem_pred[,'fsmi_mate'],
               fsmi_num_partners_sem_partners,
               xlab = 'FSMI Mate-seeking factor',
...
ggplot2::qplot(fsmi_num_partners_all_sem_pred[,'fsmi_mate'],
               splt_fsmi_devdemog$ordered_num_partner[fsmi_num_partners_all_sem_idx],
               xlab = 'FSMI Mate-seeking factor',
               ylab = 'Number of partners',
               geom = 'jitter')
...
```{r echo = F, eval = F}
save(list = save_out_list, file = file.path(save_out_dir, 'fsmi-cfa.rda'))
```
