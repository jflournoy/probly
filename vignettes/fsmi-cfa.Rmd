...
splt_lowfi_outcomes <- dplyr::mutate(
    ...
    value = dplyr::case_when(
        !grepl(' - Hungry/Thirsty', condition) & grepl('bin', outcome) ~ qnorm(value),
        TRUE ~ value))
...
all_scales_college_cor_load_splt <- lapply(
    rl_var_names_facts,
    function(rlfacts){
        lavaan::lavaan(
            model = paste(fsmi_cfa_matestat_model, dnp_cfa_model,
