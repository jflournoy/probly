...
beta_pars <- c('epsilon' = 'beta_ep_prm', 'rho' = 'beta_rho_prm', 
               'xi' = 'beta_xi_prm', 'b' = 'beta_b', 'P("right")["final"]' = 'pR_final')
...
par_means_for_corplot <- 
    dplyr::data_frame(
        'epsilon["full"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp-1528144.RDS`[beta_names_list[['beta_ep_prm']]]),
        'epsilon["no b"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp_no_b-1528233.RDS`[beta_names_list[['beta_ep_prm']]]),
        'epsilon["no b,"~rho]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp_no_b_no_rho-1527735.RDS`[beta_names_list[['beta_ep_prm']]]),
        'xi["full"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp-1528144.RDS`[beta_names_list[['beta_xi_prm']]]),
        'xi["no b"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp_no_b-1528233.RDS`[beta_names_list[['beta_xi_prm']]]),
        'xi["no b,"~rho]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp_no_b_no_rho-1527735.RDS`[beta_names_list[['beta_xi_prm']]]),
        'rho["full"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp-1528144.RDS`[beta_names_list[['beta_rho_prm']]]),
        'rho["no b"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp_no_b-1528233.RDS`[beta_names_list[['beta_rho_prm']]]),
        'b["full"]' = unlist(
            mean_pars$`splt-looser-rl_repar_exp-1528144.RDS`[beta_names_list[['beta_b']]])
    )
